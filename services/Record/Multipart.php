<?php
/**
 * Get Multiparts for Record module
 *
 * PHP version 5
 *
 ...
 * @link     http://vufind.org/wiki/building_a_module Wiki
 */
class Multipart extends Record
{
    /**
    ...
    public function launch()
    {
       global $interface;
        ...
        if (!$interface->is_cached($this->cacheId)) {
            ...
            $multipartMetadata = $this->recordDriver->getMultipartMetadata();
            $interface->assign(
                'multipartMetadata', $multipartMetadata
            );
            $interface->assign('subTemplate', 'view-multipart.tpl');
