<div id="record{$summId|escape}" class="yui-ge">
  <div class="yui-u first"><img src="{$url}/images/website.jpg" class="alignleft" alt="Website"/>
    <div class="resultitem">
      <div class="resultItemLine1">
      {foreach from=$summURLs item=recordurl}
      {/foreach}
      {if $summTitleGer}
      <a href="{$recordurl|escape}?docinput[flavour]=1" class="title"><img src="{$url}/images/de.gif"  border="0" alt="Deutsch" title="Deutsch"/>{$summTitleGer|truncate:180:"..."|highlight:$lookfor}</a>
      {if $summTitleEng}
      <br/><a href="{$recordurl|escape}?docinput[flavour]=2" class="title"><img src="{$url}/images/uk.gif"  border="0" alt="English" title="English"/>{$summTitleEng|truncate:180:"..."|highlight:$lookfor}</a>
      {/if}
      {else}
