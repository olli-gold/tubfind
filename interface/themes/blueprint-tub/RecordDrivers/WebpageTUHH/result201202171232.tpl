<div class="result recordId" id="record{$summId|escape}">
  ...
  <div class="span-9">
    <div class="resultItemLine1">
      ...
      {/if}
        <br/><a href="{$url}/Record/{$summId|escape:"url"}" class="title">
      Internansicht</a>
    </div>
    ...
    <div class="span-14 last">
        {translate text='Located'}: <span>{translate text='Website TUHH'}</span><br/>
        <a href="{$recordurl}" target="_blank">{$recordurl|truncate:54:'...':true:true}</a>
    </div>
