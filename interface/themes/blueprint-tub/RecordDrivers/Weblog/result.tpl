<div class="result recordId" id="record{$summId|escape}">
   ...
   *}
  <div class="span-2">
    <img src="{$url}/interface/themes/blueprint-tub/images/weblog.jpg" class="alignleft" alt="Weblog"/>
  </div>
  <div class="span-9">
...
*}
    ...
    <div class="span-14 last">
        {translate text='Source'}: <span>{translate text='Weblog Bibliothek TUHH'}</span>
    </div>
