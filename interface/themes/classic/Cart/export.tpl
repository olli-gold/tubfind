<div align="left">
  ...
  <div id="popupDetails">
    ...
    {else}
    <form action="{$url}/Cart/Home?export" name="exportForm" method="POST" onSubmit='exportIDS(this.elements[&quot;ids[]&quot;], this.elements[&quot;format&quot;].value,
